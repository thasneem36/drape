...
const _offers = [
  ...
  _Offer('Limited', '40% off Silk', 'A curated farewell to the season', [
    Color(0xFF8C5A3E),
    Color(0xFF5E3A26),
  ], Color(0xFFF3E0CC)),
  _Offer(
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final featured = DummyData.featured();
    final newArrivals = DummyData.products.take(4).toList();
    ...
    return DrapeScaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverToBoxAdapter(child: _header(context, cart.itemCount)),
          SliverToBoxAdapter(child: _searchBar()),
          SliverToBoxAdapter(child: _heroCard()),
          SliverToBoxAdapter(child: _categories()),
          SliverToBoxAdapter(child: _featuredRow(featured, openPdp)),
          SliverToBoxAdapter(child: _campaign()),
          SliverToBoxAdapter(child: _newArrivals(newArrivals, openPdp)),
  ...
  Widget _header(BuildContext ctx, int cartCount) {
    return Padding(
                ...
                if (cartCount > 0)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text('$cartCount', style: AppText.micro.copyWith(color: Colors.white, fontSize: 9)),
                    ),
                  ),
              ],
            ),
                      ...
                      Row(
                        children: List.generate(_offers.length, (i) {
                          return AnimatedContainer(
                            ...
                            width: i == offer ? 22 : 6,
                            decoration: BoxDecoration(
                              color: i == offer ? Colors.white : Colors.white38,
  ...
  Widget _featuredRow(List<Product> featured, void Function(Product) onTap) {
    return Padding(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'THE QUIET EDIT',
                  style: AppText.eyebrow.copyWith(color: AppColors.accentSoft),
                ),
                const SizedBox(height: 6),
                SizedBox(
                  width: 210,
  ...
  Widget _newArrivals(List<Product> items, void Function(Product) onTap) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(18, 28, 18, 0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
