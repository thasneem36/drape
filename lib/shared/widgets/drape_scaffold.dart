...
class DrapeScaffold extends StatelessWidget {
  ...
  final Widget? fab;
  final Widget? bottom;
  const DrapeScaffold({super.key, required this.body, this.tab, this.bg, this.fab, this.bottom});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: bottom ?? (tab != null ? DrapeBottomNav(current: tab!) : null),
    );
  }
}
...
class ScreenHeader extends StatelessWidget {
  ...
  const ScreenHeader({super.key, this.title, this.eyebrow, this.actions = const [], this.leading,
...
class SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text.rich(TextSpan(children: [
      ...
      if (accent != null) TextSpan(text: ' $accent', style: base.copyWith(fontStyle: FontStyle.italic)),
    ]), style: base);
  }
}
