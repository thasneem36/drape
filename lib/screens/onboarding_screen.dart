// ─────────────────────────────────────────────────────────────
// Onboarding — 3-slide carousel with gradient background.
// ─────────────────────────────────────────────────────────────
        ...
        child: SafeArea(
          child: Stack(
            children: [
              ...
              Positioned(
                top: -90, right: -90,
                child: _Ring(size: 300, alpha: 0.4),
              ),
              Positioned(
                top: -40, right: -40,
                child: _Ring(size: 200, alpha: 0.3),
              ),
              Positioned(
                bottom: 100, left: -80,
                child: _Ring(size: 240, alpha: 0.2),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Drape.', style: AppText.titleL.copyWith(
                      color: Colors.white, fontStyle: FontStyle.italic,
                    )),
                    const Spacer(),
                    Text(s.eyebrow.toUpperCase(),
                        style: AppText.eyebrow.copyWith(color: Colors.white70)),
                    ...
                    SizedBox(
                      width: 290,
                      child: Text(s.sub, style: AppText.bodyM.copyWith(
                    ...
                    Row(children: [
                      if (step < slides.length - 1) ...[
                        Expanded(child: _onbBtn('SKIP',
                            outlined: true,
                            onTap: () => Navigator.pushReplacementNamed(context, AppRoutes.login))),
                        const SizedBox(width: 10),
                        Expanded(
                          flex: 2,
                          child: _onbBtn('CONTINUE',
      ...
      child: SizedBox(
        ...
        child: Center(
          child: Text(label, style: AppText.label.copyWith(
            color: outlined ? Colors.white : AppColors.ink,
          )),
        ),
      ),
    ),
