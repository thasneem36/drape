...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    final s = kOnboardingSlides[step];
    ...
    return Scaffold(
      body: AnimatedContainer(
        ...
        child: SafeArea(
          child: Stack(
            children: [
              // Decorative rings — always visible behind the image
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Image (fills available space between logo and text) ──
                    Expanded(
                    ...
                    Row(
                      children: [
                        if (step < kOnboardingSlides.length - 1) ...[
                          Expanded(
                            child: _onbBtn(
                              'SKIP',
                              outlined: true,
...
class _Ring extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(0xFFE8D7C4).withValues(alpha: alpha),
            width: 1.5,
          ),
        ),
      );
