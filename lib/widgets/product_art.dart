// ─────────────────────────────────────────────────────────────
// Product artwork placeholder — renders a gradient swatch with
// a serif label, matching the web prototype's <ProductArt/>.
// ─────────────────────────────────────────────────────────────
    ...
    return ClipRRect(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Soft noise-ish overlay: diagonal streak using white/black alpha.
          DecoratedBox(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
