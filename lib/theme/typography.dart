...
// Load the fonts via the `google_fonts` package at runtime.
// ─────────────────────────────────────────────────────────────
...
class AppText {
  ...
  // Core font getters — apply once; override per-style.
  ...
  // Product card name (serif, not italic, less aggressive)
